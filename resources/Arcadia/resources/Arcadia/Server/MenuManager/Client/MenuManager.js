    ...
    if (name === "MenuManager_OpenMenu") {
        ...
        menu.OnCheckboxChange.connect((sender, item, checked) => {
            ...
            if (menuItem.Selectable) {
                let data = saveData();
                API.triggerServerEvent("MenuManager_Selectable", menuData.Id, menuItem.Id, index, false, API.toJson(data));
            }
        });
        ...
        let data = saveData();
        API.triggerServerEvent("MenuManager_Selectable", menuData.Id, "", menu.CurrentSelection, true, API.toJson(data));
