...
API.onKeyDown.connect(function (e, key) {
    ...
    switch (key.KeyCode) {
        ...
        case Keys.Right:
            ...
            API.displaySubtitle("Тип редактирования: ~y~" + editing_types[editing_type_idx], 2000);
            break;
        ...
        case Keys.Add:
            ...
            API.displaySubtitle("Скорость передлвижения: ~y~" + moving_speeds[moving_speed_idx], 2000);
            break;
        ...
        case Keys.Y:
            ...
            API.displaySubtitle("~g~Сохранено.", 2000);
            break;
        ...
        case Keys.N:
            ...
            API.displaySubtitle("~r~Отменено.", 2000);
            break;
    }
});
...
API.onUpdate.connect(function () {
    ...
    API.drawText("Редактирование: ~y~" + editing_types[editing_type_idx], resX, resY - 25, 0.55, 255, 255, 255, 255, 4, 0, true, true, 0);
    API.drawText("Скорость: ~y~" + moving_speeds[moving_speed_idx], resX, resY + 5, 0.55, 255, 255, 255, 255, 4, 0, true, true, 0);

    API.drawText("~b~Вверх/Вниз стрелки чтобы передвигать обьект.", resX, resY + 60, 0.45, 255, 255, 255, 255, 4, 0, true, true, 0);
    API.drawText("~b~Влево/Вправо стрелки чтобы изменить тип редактирования.", resX, resY + 90, 0.45, 255, 255, 255, 255, 4, 0, true, true, 0);
    API.drawText("~b~+/- чтобы изменить скорость.", resX, resY + 120, 0.45, 255, 255, 255, 255, 4, 0, true, true, 0);
    API.drawText("~b~Y/N чтобы сохранить/отменить редактирование.", resX, resY + 150, 0.45, 255, 255, 255, 255, 4, 0, true, true, 0);
});