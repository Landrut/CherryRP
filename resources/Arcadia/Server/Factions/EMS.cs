...
public class EMS : Script
{
    ...
    private void onResourceStart()
    {
        ...
        EMSVehicles.Add(API.createVehicle((VehicleHash)1171614426, new Vector3(304.0121, -1446.078, 29.57556), new Vector3(0.004966584, -0.5116892, -86.61472), 111, 0, 0)); // emscar1
        EMSVehicles.Add(API.createVehicle((VehicleHash)469291905, new Vector3(294.642, -1440.824, 29.42973), new Vector3(0.1124057, -0.02336958, -129.7243), 111, 0, 0)); // emscar2
        EMSVehicles.Add(API.createVehicle((VehicleHash)469291905, new Vector3(289.0313, -1436.217, 29.4304), new Vector3(0.005482068, -0.009562683, -128.8032), 111, 0, 0)); // emscar3
        EMSVehicles.Add(API.createVehicle((VehicleHash)1171614426, new Vector3(331.1278, -1468.397, 29.48061), new Vector3(-1.345117, -0.7575899, -131.5469), 111, 0, 0)); // emscar4
        EMSVehicles.Add(API.createVehicle((VehicleHash)1171614426, new Vector3(328.5711, -1471.584, 29.52323), new Vector3(-0.6989822, -0.7612198, -129.5886), 111, 0, 0)); // emscar5
        EMSVehicles.Add(API.createVehicle((VehicleHash)1171614426, new Vector3(325.3818, -1474.847, 29.57717), new Vector3(0.01555037, -0.136667, -131.0163), 111, 0, 0)); // emscar6
        EMSVehicles.Add(API.createVehicle((VehicleHash)469291905, new Vector3(335.6187, -1479.448, 29.19335), new Vector3(-2.82593, 1.104102, -59.41434), 111, 0, 0)); // emscar7
        EMSVehicles.Add(API.createVehicle((VehicleHash)353883353, new Vector3(299.4937, -1453.769, 46.8985), new Vector3(0.1626782, -0.003988226, -39.80795), 111, 1, 0)); // emscar8
        EMSVehicles.Add(API.createVehicle((VehicleHash)353883353, new Vector3(313.0501, -1465.497, 46.89686), new Vector3(-0.03698704, -0.006741742, -41.51336), 111, 1, 0)); // emscar9
        ...
        EMSHealColshape.onEntityEnterColShape += (shape, Entity) =>
        {
            Client player;
            player = API.getPlayerFromHandle(Entity);
            API.sendPictureNotificationToPlayer(player, "Давайте мне ваш рецептик", "CHAR_PLANESITE", 0, 3, "Врач", "Препарат по рецепту");
        };
