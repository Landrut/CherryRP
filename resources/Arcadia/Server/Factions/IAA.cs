...
public class IAA : Script
{
    ...
    public void onResourceStart()
    {
        ...
        IAAVehicles.Add(API.createVehicle((VehicleHash)1777363799, new Vector3(180.7228, -695.4959, 32.65022), new Vector3(0.0448116, 0.02781741, 68.04761), 0, 0, 0)); // IAA3
        IAAVehicles.Add(API.createVehicle((VehicleHash)1777363799, new Vector3(179.4471, -699.0682, 32.65387), new Vector3(-0.04408736, 0.0232578, 69.96588), 0, 0, 0)); // IAA4
        IAAVehicles.Add(API.createVehicle((VehicleHash)1777363799, new Vector3(176.6556, -706.7001, 32.65643), new Vector3(-0.04583715, 0.01724948, 71.07574), 0, 0, 0)); // IAA5
        IAAVehicles.Add(API.createVehicle((VehicleHash)1777363799, new Vector3(175.3861, -710.3008, 32.65231), new Vector3(0.1519537, -0.09569856, 71.30284), 0, 0, 0)); // IAA6
        IAAVehicles.Add(API.createVehicle((VehicleHash)80636076, new Vector3(176.9267, -687.4487, 32.41441), new Vector3(0.01605958, 0.01524466, 158.1595), 0, 0, 0)); // IAA7
        IAAVehicles.Add(API.createVehicle((VehicleHash)80636076, new Vector3(173.3816, -686.1784, 32.41327), new Vector3(0.08822118, 0.015526, 160.6771), 0, 0, 0)); // IAA8
        IAAVehicles.Add(API.createVehicle((VehicleHash)80636076, new Vector3(169.949, -684.9019, 32.41516), new Vector3(0.06634739, -0.01591411, 158.6185), 0, 0, 0)); // IAA9
        IAAVehicles.Add(API.createVehicle((VehicleHash)1127131465, new Vector3(163.9526, -682.7216, 32.77159), new Vector3(0.03492415, -0.07807794, 158.4769), 0, 0, 0)); // IAA10
        IAAVehicles.Add(API.createVehicle((VehicleHash)1127131465, new Vector3(156.5536, -680.0181, 32.77141), new Vector3(0.07767295, -0.004634133, 159.8455), 0, 0, 0)); // IAA12
        IAAVehicles.Add(API.createVehicle((VehicleHash)1127131465, new Vector3(160.2556, -681.3813, 32.77168), new Vector3(0.04791036, -0.01453344, 159.5819), 111, 111, 0)); // IAA12
        IAAVehicles.Add(API.createVehicle((VehicleHash)(-1647941228), new Vector3(144.8737, -695.3228, 32.74929), new Vector3(0.03091615, 0.100222, -112.3799), 111, 111, 0)); // IAA13
        IAAVehicles.Add(API.createVehicle((VehicleHash)(-1647941228), new Vector3(143.687, -698.4905, 32.74855), new Vector3(0.04075204, -0.01167959, -110.049), 111, 111, 0)); // IAA14
        IAAVehicles.Add(API.createVehicle((VehicleHash)(-1647941228), new Vector3(148.9858, -683.85, 32.7524), new Vector3(-0.004184504, -0.06868739, -109.2714), 0, 0, 0)); // IAA1
        IAAVehicles.Add(API.createVehicle((VehicleHash)(-1647941228), new Vector3(147.6422, -687.5766, 32.75058), new Vector3(-0.0121687, -0.05119393, -109.288), 0, 0, 0)); // IAA2
            ...
            if (lsIaafaction == 4)
            {
                ...
                if (onduty == 1)
                {
                    if (weaponcare == false)
                    {
                        ...
                        API.sendPictureNotificationToPlayer(player, "Проверь все, ато бывали случаи...", "CHAR_STEVE", 0, 3, "Служба безопасности", "Обращение к сотруднику");
                    ...
                    if (weaponcare == true)
                    {
                        ...
                        API.sendPictureNotificationToPlayer(player, "Я передам на пост чтобы почистили твои игрушки", "CHAR_STEVE", 0, 3, "Служба безопасности", "Обращение к сотруднику");
                        weaponcare = false;
                        return;
                    }
                }
