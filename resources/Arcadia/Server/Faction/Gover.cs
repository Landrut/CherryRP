...
public class Gover : Script
{
    ...
    public void onResourceStart()
    {
        ...
        {
            API.createVehicle((VehicleHash)1922255844, new Vector3(252.8146, -376.0839, 44.03017), new Vector3(1.224683, 1.318173, -108.9697), 111, 111, 0), // Gov1
            API.createVehicle((VehicleHash)(-1961627517), new Vector3(259.1023, -378.563, 44.27523), new Vector3(1.229927, 1.000891, -110.2085), 111, 111, 0), // Gov2
            API.createVehicle((VehicleHash)666166960, new Vector3(265.7706, -380.8165, 44.62334), new Vector3(1.005567, -0.2588988, -105.3974), 111, 111, 0), // Gov3
            API.createVehicle((VehicleHash)(-888242983), new Vector3(241.3348, -372.3481, 43.85332), new Vector3(1.061412, 1.332742, -108.3704), 111, 111, 0), // Gov4
            API.createVehicle((VehicleHash)704435172, new Vector3(235.9972, -370.5287, 43.74553), new Vector3(0.5981793, 1.137748, -109.527), 111, 111, 0), // Gov5
            API.createVehicle((VehicleHash)666166960, new Vector3(230.8293, -368.6938, 44.08332), new Vector3(0.7242315, 1.13114, -109.026), 111, 111, 0) // Gov6
        };
